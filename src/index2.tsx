//
// Экзамен #16
// 🐢 Работа с сервером. Axios запросы
...
//
// // 🖥 Пример ответа: return Promise.resolve() //////return instance.get('posts')  +++++++
...
//
// // 🖥 Пример ответа:  .then((res: any) => setTodo(res.data.data)) ////// return instance.get<TodoType>(`todos/${todoId}`) ПРОБЕЛ!!!!!!
